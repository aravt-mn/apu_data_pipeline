...
CMD ["bash", "-c", "if [ ! -f /home/src/${PROJECT_NAME}/metadata.yaml ]; then echo 'metadata.yaml does not exist, initializing...'; mage init /home/src/${PROJECT_NAME}; else echo 'metadata.yaml exists, skipping initialization'; fi && mage start ${PROJECT_NAME}"]